...
AUTHOR_SERVICE_CONTAINER_IMAGE="${CONTAINER_REGISTRY}/${ACCOUNT_NAME}/bookdb-author-service:${IMAGE_TAG}"
BOOK_SERVICE_CONTAINER_IMAGE="${CONTAINER_REGISTRY}/${ACCOUNT_NAME}/bookdb-book-service:${IMAGE_TAG}"
COMMENT_SERVICE_CONTAINER_IMAGE="${CONTAINER_REGISTRY}/${ACCOUNT_NAME}/bookdb-comment-service:${IMAGE_TAG}"
